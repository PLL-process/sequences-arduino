...
(() => {
  ...
  const visualId = visualIds[n] || "v02";

  const style = document.createElement("style");
  style.textContent = ".realSessionVisual{width:100%;height:100%;border-radius:12px;overflow:hidden;background:#08251d}.realSessionVisual svg{display:block;width:100%;height:100%}.realSessionNote{margin:.75rem 0 0;padding:.75rem .85rem;border:1px solid #31536a;border-left:5px solid var(--session-accent,#22d3ee);border-radius:11px;background:#07131f;color:#dce9ef;line-height:1.45}";
  ...
  visual.innerHTML = `<svg viewBox="0 0 640 360" preserveAspectRatio="xMidYMid meet" aria-hidden="true" focusable="false"><use href="images/technoquest-visuels.svg?v=27#${visualId}"></use></svg>`;
