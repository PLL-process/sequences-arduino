...
(() => {
  ...
  const enhance = () => {
    ...
    if (toggle && !document.getElementById("representationHelp")) {
      ...
      help.innerHTML = "<strong>Deux regards complémentaires :</strong> utilise d’abord le schéma, clique sur « Lancer la démonstration » pour simuler les flux, puis passe à la vue réelle pour reconnaître le matériel.";
